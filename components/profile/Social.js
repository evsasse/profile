...
const Social = () => (
  <section>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
      ...
      <p>
        <i aria-hidden className="fab fa-fw mr-1 fa-angellist"></i>
      ...
      <p>
        <i aria-hidden className="fab fa-fw mr-1 fa-gitlab"></i>
      ...
      <p>
        <i aria-hidden className="fab fa-fw mr-1 fa-hacker-news-square"></i>
